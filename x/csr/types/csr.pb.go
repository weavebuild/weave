...
// source: tomahawk/csr/v1/csr.proto
...
func init() {
	proto.RegisterType((*CSR)(nil), "tomahawk.csr.v1.CSR")
}

func init() { proto.RegisterFile("tomahawk/csr/v1/csr.proto", fileDescriptor_57c53cea3d443afa) }
