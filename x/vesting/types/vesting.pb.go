...
// source: tomahawk/vesting/v1/vesting.proto
...
func init() {
	proto.RegisterType((*ClawbackVestingAccount)(nil), "tomahawk.vesting.v1.ClawbackVestingAccount")
}

func init() { proto.RegisterFile("tomahawk/vesting/v1/vesting.proto", fileDescriptor_c580f9d3d2a7f889) }
