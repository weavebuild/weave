...
import (
	...
	"github.com/tomahawk-network/tomahawk/v6/x/vesting/types"
)
...
// Example:
// 21/10 Employee joins tomahawk and vesting starts
...
func delegate(clawbackAccount *types.ClawbackVestingAccount, amount int64) error {
	...
	s.Require().NoError(err)
	//
	val, err := sdk.ValAddressFromBech32("tomahawkvaloper1z3t55m0l9h0eupuz3dp5t5cypyv674jjvj4sdt")
	s.Require().NoError(err)
