...
// source: tomahawk/govshuttle/v1/govshuttle.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "tomahawk.govshuttle.v1.Params")
	proto.RegisterType((*LendingMarketProposal)(nil), "tomahawk.govshuttle.v1.LendingMarketProposal")
	proto.RegisterType((*TreasuryProposal)(nil), "tomahawk.govshuttle.v1.TreasuryProposal")
	proto.RegisterType((*TreasuryProposalMetadata)(nil), "tomahawk.govshuttle.v1.TreasuryProposalMetadata")
	proto.RegisterType((*LendingMarketMetadata)(nil), "tomahawk.govshuttle.v1.LendingMarketMetadata")
}

func init() {
	proto.RegisterFile("tomahawk/govshuttle/v1/govshuttle.proto", fileDescriptor_39f3a63fcc428040)
}
