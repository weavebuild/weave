...
// source: tomahawk/inflation/v1/inflation.proto
...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "tomahawk.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "tomahawk.inflation.v1.ExponentialCalculation")
}

func init() {
	proto.RegisterFile("tomahawk/inflation/v1/inflation.proto", fileDescriptor_aa2aa1764b029465)
}
