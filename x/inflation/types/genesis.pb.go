...
// source: tomahawk/inflation/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "tomahawk.inflation.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "tomahawk.inflation.v1.Params")
}

func init() { proto.RegisterFile("tomahawk/inflation/v1/genesis.proto", fileDescriptor_5da850aabf0c3ac5) }
