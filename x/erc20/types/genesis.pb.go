...
// source: tomahawk/erc20/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "tomahawk.erc20.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "tomahawk.erc20.v1.Params")
}

func init() { proto.RegisterFile("tomahawk/erc20/v1/genesis.proto", fileDescriptor_6af5bf0eee46eaa1) }
