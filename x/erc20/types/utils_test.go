	...
	testCases := []struct {
	...
	}{
		{
			...
			banktypes.Metadata{
				...
				Name:        "tomahawk",
				Symbol:      "tomahawk",
				Description: "EVM, staking and governance denom of tomahawk",
				DenomUnits: []*banktypes.DenomUnit{
					{
						Denom:    "atoma",
						Exponent: 0,
						Aliases:  []string{"atto tomahawk"},
					},
					{
						Denom:    "tomahawk",
						Exponent: 18,
...
func TestEqualAliases(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			[]string{"atto tomahawk", "atoma"},
			[]string{"atoma", "atto tomahawk"},
			false,
		},
		{
			"same values, sorted",
