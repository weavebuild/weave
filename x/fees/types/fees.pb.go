...
// source: tomahawk/fees/v1/fees.proto
...
func init() {
	proto.RegisterType((*Fee)(nil), "tomahawk.fees.v1.Fee")
}

func init() { proto.RegisterFile("tomahawk/fees/v1/fees.proto", fileDescriptor_a3e4bdb330dad752) }
