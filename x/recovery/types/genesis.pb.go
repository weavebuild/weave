...
// source: tomahawk/recovery/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "tomahawk.recovery.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "tomahawk.recovery.v1.Params")
}

func init() { proto.RegisterFile("tomahawk/recovery/v1/genesis.proto", fileDescriptor_5b0a30f85f43314c) }
