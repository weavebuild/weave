...
import (
	...
	tomahawkapp "github.com/tomahawk-network/tomahawk/v6/app"
	ethermint "github.com/evmos/ethermint/types"
)

var DefaultTestingAppInit func() (ibcgotesting.TestingApp, map[string]json.RawMessage) = tomahawkapp.SetupTestingApp
...
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, chainID string, balances ...banktypes.Balance) ibcgotesting.TestingApp {
	...
	app.InitChain(
		abci.RequestInitChain{
			...
			ConsensusParams: tomahawkapp.DefaultConsensusParams,
