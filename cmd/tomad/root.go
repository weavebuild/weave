...
import (
	...
	cmdcfg "github.com/tomahawk-network/tomahawk/v6/cmd/config"
	tomahawkkr "github.com/tomahawk-network/tomahawk/v6/crypto/keyring"
)
...
// NewRootCmd creates a new root command for tomad. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(tomahawkkr.Option()).
		WithViper(EnvPrefix)

	rootCmd := &cobra.Command{
		Use:   app.Name,
		Short: "tomahawk daemon",
...
func (a appCreator) appExport(
	...
	if height != -1 {
		tomahawkApp = app.NewTomahawk(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := tomahawkApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		tomahawkApp = app.NewTomahawk(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}

	return tomahawkApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
